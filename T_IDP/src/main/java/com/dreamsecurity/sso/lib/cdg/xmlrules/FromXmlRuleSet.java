...
public class FromXmlRuleSet extends RuleSetBase {
    ...
    public static final String DIGESTER_DTD_PATH = "com/dreamsecurity/sso/lib/cdg/xmlrules/digester-rules.dtd";
     ...
     * @see com.dreamsecurity.sso.lib.cdg.RuleSetBase
     */
    public void addRuleInstances(com.dreamsecurity.sso.lib.cdg.Digester digester) throws XmlLoadException {
    ...
    com.dreamsecurity.sso.lib.cdg.Digester digester,
    String basePath) 
