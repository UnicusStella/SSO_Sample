...
<%
	...
	request.setAttribute("logout", "siluet_logout_url");
	...
	try {
		...
		result = idp.receiveSiluetRequestS(request);
	...
	result = null;
	result = idp.authnSiluetConnectS(request);
	...
	result = null;
	result = idp.generateSiluetResponseS(request);
	...
	if (Integer.parseInt((String) result.get("code")) != MStatus.SUCCESS) {
 	...
 	boolean sendResult = SendUtil.sendSiluetResponse(response, request, (String) result.get("data"));
