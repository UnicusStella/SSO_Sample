...
<%
	...
	if (cmd.equals("LoaderTest")) {
		...
		out.print(htmlMsg(boldTag("1. com.dreamsecurity.sso.server.config.LoaderTest Find ...")));
		String reqName = "com.dreamsecurity.sso.server.config.LoaderTest";

		try {
			URL classUrl = this.getClass().getResource("/com/dreamsecurity/sso/server/config/LoaderTest.class");
