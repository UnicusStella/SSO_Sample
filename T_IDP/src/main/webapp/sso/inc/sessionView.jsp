...
<html>
<head>
<title>Magic SSO Server Session</title>
...
<body>
	<div id="content">
		<h1 align="center">Magic SSO Server - <%=SSOConfig.getInstance().getServerName()%></h1>
		<div id="subcontent">
		...
		<table>
			...
			<tbody>
				<tr>
					<td id='headkey'>IDP_Session</td>
					<td id='headval'><%=session.getId()%></td>
				</tr>
				<tr>
					<td id='headkey'>IDP_Server_IP</td>
					<td id='headval'><%=Util.getServerIP()%></td>
				</tr>
				<%
