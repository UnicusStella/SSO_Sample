...
<%
	...
	if (Util.isEmpty(encData)) {
		...
		result.put("code", String.valueOf(6801));
		result.put("message", "SP: Login parameter is Empty");
		result.put("data", "");
	...
	try {
		result = ServiceProvider.getInstance().csLogin2FA(IDP_REQUEST_C_URL, encData);

		if (result == null) {
			throw new SSOException("Login result null");
		}
	}
	catch (SSOException e) {
		result = new JSONObject();
		result.put("code", String.valueOf(6802));
