...
public class DupManager
{
	...
	public static final int FLAG_SET_PRELOGIN_OUT = 4;

	public static final String CMD_CHECK_LOGIN = "DPMS0000";
	public static final String CMD_SET_PRELOGIN_OUT = "DPMS0004";
	...
	public String checkLogin(Map<String, String> param)
	{
		return doprocess(makeSendMsg(CMD_CHECK_LOGIN, param));
	}

	public void setPreLoginOut(Map<String, String> param)
	{
		doprocess(makeSendMsg(CMD_SET_PRELOGIN_OUT, param));
	}
