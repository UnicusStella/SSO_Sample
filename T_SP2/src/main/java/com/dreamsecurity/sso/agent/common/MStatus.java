package com.dreamsecurity.sso.agent.common;
...
public class MStatus
{
	...
	public static final int AUTH_SUBJECT_VALUE_INVALID = 20005;
	public static final int AUTH_NON_LOGIN = 2006;
	public static final int AUTH_PARAM_INVALID = 2007;
	...
	public static final int ASSERT_ID_INVALID = 2206;
	public static final int ASSERT_ISSUE_TIME_INVALID = 2207;
